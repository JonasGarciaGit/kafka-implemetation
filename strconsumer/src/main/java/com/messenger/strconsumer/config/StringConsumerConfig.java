package com.messenger.strconsumer.config;
...
public class StringConsumerConfig {
    ...
    //Listener who ill stay listening my topic
    @Bean
    ...
    //Listener who ill stay listening my topic but ill intercept message and do something
    @Bean
